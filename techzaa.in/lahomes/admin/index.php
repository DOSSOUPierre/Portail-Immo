<?php
// --- index.php (Page d'Accueil - REDESIGN Rouge #F20530) ---
...
try {
    if (isset($pdo)) {
        // *** VÉRIFIEZ VOS NOMS DE COLONNES ET TABLES ***
        $stmt = $pdo->prepare(
...
<head>
    ...
    <title>Gestion Locative Notariale | Sécurité et Simplicité au Bénin</title>
    ...
    <!-- === CSS Intégré avec NOUVELLE COULEUR ACCENT === -->
    <style>
        /* ==========================================================================
           Base & Variables (Couleur Accent Modifiée)
           ========================================================================== */
        :root {
            ...
            /* --- NOUVELLES COULEURS ACCENT --- */
            --couleur-accent: #F20530;         /* Rouge Vif */
            --couleur-accent-hover: #ff3355;   /* Rouge un peu plus clair/vif pour hover */
            --couleur-accent-rgb: 242, 5, 48;   /* RGB de #F20530 */
            /* --- Fin Nouvelles Couleurs --- */
            --couleur-primaire-rgb: 10, 25, 47;
            --couleur-texte-primaire: #ccd6f6;
            --couleur-texte-secondaire: #8892b0;
            --couleur-texte-dark: #343a40;
        ...
        /* ==========================================================================
           ...
           ========================================================================== */
        body {
            font-family: var(--font-texte); color: var(--couleur-texte-dark); line-height: 1.7; background-color: var(--couleur-fond-blanc); font-weight: 400; font-size: 16px; overflow-x: hidden; -webkit-font-smoothing: antialiased; -moz-osx-font-smoothing: grayscale;
        }
        ...
        /* Utilisation des nouvelles couleurs accent pour le gradient */
        ...
        /* Sélection avec nouvelle couleur accent */
        ::selection { background: var(--couleur-accent); color: var(--couleur-fond-blanc); } /* Texte blanc sur fond rouge */

        /* ==========================================================================
           Navbar v2 - Nouveau Style
           ========================================================================== */
        .navbar { transition: background-color 0.4s var(--easing-smooth), box-shadow 0.4s var(--easing-smooth), padding 0.4s var(--easing-smooth); padding-top: 1.25rem; padding-bottom: 1.25rem; background-color: transparent; position: fixed; width: 100%; z-index: 1030; border: none; }
        .navbar-brand { color: var(--couleur-fond-blanc) !important; font-weight: 800; font-size: 1.8rem; font-family: var(--font-titre); transition: color var(--transition-fast); }
        .nav-link { color: rgba(255, 255, 255, 0.9) !important; font-weight: 500; margin-left: 10px; margin-right: 10px; transition: color var(--transition-fast), background-color var(--transition-fast); position: relative; padding: 0.5rem 0.8rem; border-radius: var(--border-radius-sm); font-size: 0.95rem; }
        .nav-link:hover, .nav-link.active { color: var(--couleur-fond-blanc) !important; background-color: rgba(255, 255, 255, 0.1); }
        .nav-link.active { font-weight: 600; }
        .navbar.scrolled { background-color: var(--couleur-fond-blanc) !important; box-shadow: var(--shadow-md); padding-top: 0.75rem; padding-bottom: 0.75rem; }
        .navbar.scrolled .navbar-brand { color: var(--couleur-primaire) !important; }
        .navbar.scrolled .nav-link { color: var(--couleur-texte-dark) !important; }
        .navbar.scrolled .nav-link:hover { color: var(--couleur-primaire) !important; background-color: rgba(var(--couleur-accent-rgb), 0.1); } /* Hover utilise nouvelle couleur accent */
        .navbar.scrolled .nav-link.active { font-weight: 600; color: var(--couleur-accent) !important; background-color: rgba(var(--couleur-accent-rgb), 0.15); } /* Active utilise nouvelle couleur accent */
        .navbar .btn { padding: 0.4rem 1rem; font-weight: 600; transition: all var(--transition-fast); border-radius: var(--border-radius-sm); }
        /* Bouton Accent: Fond rouge, texte BLANC */
        .navbar .btn-accent { background-color: var(--couleur-accent); border-color: var(--couleur-accent); color: var(--couleur-fond-blanc); }
        .navbar .btn-accent:hover { background-color: var(--couleur-accent-hover); border-color: var(--couleur-accent-hover); transform: translateY(-2px); color: var(--couleur-fond-blanc); }
        .navbar .btn-outline-light { border-color: rgba(255, 255, 255, 0.7); color: var(--couleur-fond-blanc); }
        .navbar .btn-outline-light:hover { background-color: rgba(255, 255, 255, 0.1); color: var(--couleur-fond-blanc); border-color: var(--couleur-fond-blanc); }
        .navbar.scrolled .btn-outline-light { border-color: var(--couleur-primaire) !important; color: var(--couleur-primaire) !important; background-color: transparent !important; }
        .navbar.scrolled .btn-outline-light:hover { background-color: rgba(var(--couleur-primaire-rgb), 0.05) !important; color: var(--couleur-primaire) !important; border-color: var(--couleur-primaire) !important; }
        ...
        @media (max-width: 991.98px) {
            ...
            .navbar .nav-item:last-child .nav-link { border-bottom: none; }
             ...
             /* Mobile : Bouton Accent utilise texte blanc */
             .navbar .navbar-nav .btn-accent { background-color: var(--couleur-accent); color: var(--couleur-fond-blanc); border-color: var(--couleur-accent); }
              .navbar .navbar-nav .btn-accent:hover { background-color: var(--couleur-accent-hover); border-color: var(--couleur-accent-hover); color: var(--couleur-fond-blanc); }
        }
        ...
        .hero-section .highlight { color: var(--couleur-accent); } /* Texte en rouge */
        ...
        .search-bar-hero .form-control:focus, .search-bar-hero .form-select:focus { background-color: rgba(255, 255, 255, 0.15); border-color: var(--couleur-accent); box-shadow: 0 0 0 0.2rem rgba(var(--couleur-accent-rgb), 0.25); color: var(--couleur-fond-blanc); outline: none; } /* Ombre focus rouge */
        ...
        /* Bouton Recherche: Fond rouge, texte BLANC */
        .search-bar-hero .btn-primary { background-color: var(--couleur-accent); border-color: var(--couleur-accent); color: var(--couleur-fond-blanc); font-weight: 600; padding: 0.8rem 1.5rem; font-size: 1.05rem; border-radius: var(--border-radius-md); transition: all var(--transition-fast); width: 100%; height: calc(1.5em + 1.6rem + 2px); display: flex; align-items: center; justify-content: center; }
        .search-bar-hero .btn-primary:hover { background-color: var(--couleur-accent-hover); border-color: var(--couleur-accent-hover); transform: translateY(-2px); box-shadow: 0 4px 10px rgba(var(--couleur-accent-rgb), 0.3); color: var(--couleur-fond-blanc); }
        ...
        .property-card .card-title a:hover { color: var(--couleur-accent); } /* Hover titre en rouge */
        ...
        .property-card .card-text i { vertical-align: middle; font-size: 1rem; position: relative; top: -1px; margin-right: 0.25rem; color: var(--couleur-tertiaire); } /* Icône localisation plus discrète */
        .property-card .price { font-size: 1.4rem; font-weight: 700; color: var(--couleur-primaire); font-family: var(--font-titre); line-height: 1; } /* Prix reste en couleur primaire */
        ...
        .property-card:hover .detail-arrow { opacity: 1; color: var(--couleur-accent); transform: translateX(0px); } /* Flèche devient rouge au survol */
        ...
        .service-item:hover { transform: translateY(-10px); box-shadow: var(--shadow-lg); border-color: rgba(var(--couleur-accent-rgb), 0.5); } /* Bordure rouge léger au survol */
        .service-icon { font-size: 3rem; line-height: 1; margin-bottom: 20px; display: inline-block; color: var(--couleur-accent); transition: transform 0.5s ease; } /* Icône en rouge */
        ...
        /* Bouton CTA Accent : Fond rouge, texte BLANC */
        .cta-section .btn-accent { background-color: var(--couleur-accent); border-color: var(--couleur-accent); color: var(--couleur-fond-blanc); }
        .cta-section .btn-accent:hover { background-color: var(--couleur-accent-hover); border-color: var(--couleur-accent-hover); transform: translateY(-3px); box-shadow: 0 5px 15px rgba(var(--couleur-accent-rgb), 0.2); color: var(--couleur-fond-blanc); }
        ...
        .footer-links a:hover { color: var(--couleur-accent); padding-left: 5px; } /* Hover liens footer en rouge */
        .footer-contact li { margin-bottom: 0.8rem; display: flex; align-items: flex-start; line-height: 1.6; }
        .footer-contact i { color: var(--couleur-accent); margin-right: 12px; font-size: 1.1rem; margin-top: 4px; flex-shrink: 0; width: 1.2em; } /* Icônes contact en rouge */
        .footer-contact span { display: block; } .footer-contact a { color: var(--couleur-texte-secondaire); } .footer-contact a:hover { color: var(--couleur-accent); } /* Hover liens contact en rouge */
        ...
        .social-icons a:hover { color: var(--couleur-accent); transform: translateY(-3px); } /* Hover icônes sociales en rouge */
        .social-icons a:last-child { margin-right: 0; }
        .footer-bottom { border-top: 1px solid rgba(255, 255, 255, 0.1); padding-top: 30px; margin-top: 40px; }
        .footer-bottom p { color: rgba(204, 214, 246, 0.6); font-size: 0.85rem; } .footer-bottom a { color: rgba(204, 214, 246, 0.7); } .footer-bottom a:hover { color: var(--couleur-accent); } /* Hover liens copyright en rouge */
    ...
    <div class="wrapper">
        <header>
             ...
             <nav class="navbar navbar-expand-lg fixed-top">
                 <div class="container">
                     <!-- Utilisation de la classe .accent pour le point rouge -->
                     ...
                     <div class="collapse navbar-collapse" id="navbarNav">
                         <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-lg-center">
                             ...
                             <li class="nav-item"><a class="nav-link" href="biens_disponibles.php">Biens à Louer</a></li>
                ...
                <div class="container">
                     <div class="hero-content">
                        ...
                        <div class="search-container mt-5">
                             <!-- Le formulaire de recherche pointe maintenant vers biens_disponibles.php -->
                            <form class="search-bar-hero p-4" action="biens_disponibles.php" method="GET">
                ...
                <div class="container">
                    ...
                    <div class="row g-4 justify-content-center">
                        ...
                        <?php elseif (!empty($biensAlaUne)): ?>
                            <?php foreach ($biensAlaUne as $index => $bien): ?>
                                <?php
                                    ...
                                    // Lien vers la page de détails (vérifie le nom du fichier si besoin)
                                    $detailsUrl = "details_bien.php?id=" . urlencode($bienId);
                                ...
                                <div class="col-lg-4 col-md-6 property-card-item">
                                    <div class="card property-card h-100">
                                        <div class="img-container position-relative">
                                             ...
                                             <!-- Le badge n'est plus affiché car on n'a pas le type ici -->
                                        </div>
                     ...
                     <div class="text-center mt-5 section-footer">
                          <!-- Lien vers la page listant TOUS les biens -->
                         <a href="biens_disponibles.php" class="btn btn-primary btn-lg">
            ...
            <section class="cta-section section-padding text-center">
                 <div class="container">
                     ...
                     <div class="cta-buttons mt-4">
                         <a href="biens_disponibles.php" class="btn btn-accent btn-lg"> <i class="ri-search-line"></i> Explorer les Biens </a>
        ...
        <footer class="site-footer">
              <div class="container">
                  <div class="row g-4 g-lg-5 pb-5">
                      ...
                      <div class="col-lg-2 col-md-3 col-6"> <h6 class="footer-heading">Navigation</h6> <ul class="list-unstyled footer-links"> <li><a href="index.php">Accueil</a></li> <li><a href="biens_disponibles.php">Biens à louer</a></li> <li><a href="#services">Nos services</a></li> <li><a href="contact.php">Contact</a></li> </ul> </div>
